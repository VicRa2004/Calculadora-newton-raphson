...
const Iteracion = ({ data }) => {
  const { i, dataForm, x0, x1, err: error, fx, derivadaFx } = data;

  const ecuacionProblema = dataForm.ecuacion;
  ...
  return (
    <div className="border-2 border-emerald-300 p-2 rounded-lg flex flex-col gap-1 text-lg">
      ...
      <h4 className="font-medium">
        X({i}): <span className="font-normal">{x0}</span>
      </h4>
